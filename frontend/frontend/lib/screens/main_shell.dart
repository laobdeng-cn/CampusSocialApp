    ...
    return CampusCard(
      ...
      child: Stack(
        children: [
          ...
          if (entry.unread)
            const Positioned(right: 0, top: 50, child: _UnreadDot(size: 8)),
        ],
      ),
    );
  }
...
const _privateChatEntries = [
  _PrivateChatEntry(
    user: zihao,
    message: '关于周末的摄影活动，你有时间吗？',
    time: '2分钟前',
    unreadCount: 2,
    pinned: true,
    online: true,
  ...
  _PrivateChatEntry(
    user: siyu,
    message: '谢谢你的资料分享！对我们的组会很有帮助～',
    time: '15分钟前',
    unreadCount: 1,
    online: true,
  ),
  _PrivateChatEntry(user: xiaobei, message: '明天的社团招新摊位需要几个人值班？', time: '1小时前'),
  _PrivateChatEntry(
    user: kexin,
    message: '下周一起去图书馆自习吧？',
    time: '3小时前',
  ...
  _PrivateChatEntry(
    user: xiaochen,
    name: '张宇航',
    message: '关于大创项目的想法，想和你讨论一下',
    time: '5小时前',
  ),
  _PrivateChatEntry(
    user: siyu,
    name: '摄影协会-琪琪',
    message: '周六的外拍活动已更新到群公告啦',
    time: '昨天',
    online: true,
  ),
  _PrivateChatEntry(
...
class _WeatherChatBubble extends StatelessWidget {
  const _WeatherChatBubble({required this.user});
    ...
    return CampusCard(
      ...
      child: Stack(
        children: [
          ...
          if (entry.unread)
            const Positioned(right: 0, top: 48, child: _UnreadDot(size: 8)),
        ],
      ),
    );
  }
...
const _profileOwner = CampusUser(
  name: '陈可欣',
  school: '设计学院',
  major: '视觉传达',
  grade: '大二',
  avatarUrl: 'asset:assets/images/kexin_avatar.png',
  bio: '热爱生活，热爱摄影，期待遇见更多有趣的人',
  role: '摄影协会',
);

const _profilePosts = [
  CampusPost(
    author: _profileOwner,
    title: '校园日落拍摄地推荐',
    body: '今天的晚霞也太美了！在图书馆顶楼拍到的，分享给大家几个适合拍照的小位置～',
    topic: '摄影作品分享',
    images: ['asset:assets/images/profile_sunset.png'],
    location: '图书馆顶楼',
    createdAt: '2小时前',
    likes: 128,
    comments: 23,
  ...
  CampusPost(
    author: _profileOwner,
    title: '图书馆自习打卡',
    body: '周末也要努力学习呀～ 推荐几本最近在看的书，真的很有收获！',
    topic: '校园生活',
  ...
  CampusPost(
    author: _profileOwner,
    title: '食堂新品测评｜芝士焗饭绝了！',
    body: '新出的芝士焗饭也太香了吧！奶香浓郁，料超足，学生党福音，强烈推荐～',
    topic: '美食测评',
    images: [
...
const _profileActivities = [
  _ProfileActivityEntry(
    relationLabel: '我报名的',
    relationColor: AppColors.blue,
    stateLabel: '报名中',
    stateColor: AppColors.blue,
    actionLabel: '查看详情',
    activity: CampusActivity(
      ...
      capacity: 300,
      price: '免费',
      description: '用音乐点亮校园之夜，一起享受现场演出的热烈氛围。',
      highlights: ['校园乐队', '现场互动', '舞台演出'],
      guests: [_profileOwner],
    ),
  ),
  _ProfileActivityEntry(
    relationLabel: '我参加过',
    relationColor: AppColors.green,
    stateLabel: '已结束',
    ...
    activity: CampusActivity(
      ...
      capacity: 36,
      price: '免费',
      description: '和摄影社团一起出发，把山海与日落收进镜头。',
      highlights: ['户外采风', '作品点评', '同好交流'],
      guests: [_profileOwner],
    ),
  ),
  _ProfileActivityEntry(
    relationLabel: '我发起的',
    relationColor: AppColors.orange,
    stateLabel: '报名中',
    stateColor: AppColors.blue,
    actionLabel: '管理活动',
    activity: CampusActivity(
      ...
      capacity: 100,
      price: '免费',
      description: '聊聊作品集、视觉表达和设计学习里的真实经验。',
      highlights: ['作品分享', '作品集建议', '自由交流'],
      guests: [_profileOwner],
    ),
  ),
];
...
const _albumSections = [
  _AlbumSection(
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1496307653780-42ee777d4833?auto=format&fit=crop&w=700&q=80',
    ],
  ),
  _AlbumSection(
    title: '活动记录',
  ...
  _AlbumSection(
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1452421822248-d4c2b47f0c81?auto=format&fit=crop&w=700&q=80',
      'https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=700&q=80',
          ...
          const Positioned(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8),
                Icon(Icons.copy_all_outlined, size: 18, color: AppColors.muted),
              ],
            ),
          ),
          Positioned(
          ...
          Positioned(
            ...
            child: Wrap(
              ...
              children: [
                ...
                const _CompactBadge(label: 'ENFJ', color: AppColors.blue),
                const _CompactBadge(label: '广东 · 深圳', color: AppColors.blue),
              ],
            ),
          ),
          const Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                _ProfileStat(value: '256', label: '粉丝'),
                _ProfileStat(value: '36', label: '获赞'),
                _ProfileStat(value: '12', label: '活动'),
              ],
            ),
          ),
        ],
...
String _profileBioFor(CampusUser user) {
  if (user.name == '陈可欣') {
    return '热爱生活，热爱摄影，期待遇见更多有趣的人';
  }
  return user.bio.isEmpty ? '热爱生活，热爱摄影，期待遇见更多有趣的人' : user.bio;
}

String _profileGradeFor(CampusUser user) {
  if (user.name == '陈可欣') return '大二';
  return user.grade;
}

String _profileClubFor(CampusUser user) {
  if (user.name == '陈可欣') return '摄影协会';
  return user.role ?? user.major;
}

class _ProfileActivityEntry {
  const _ProfileActivityEntry({
...
class _ProfileShortcutCard extends StatelessWidget {
  const _ProfileShortcutCard({required this.user});
...
class _MyPostsScreenState extends State<_MyPostsScreen> {
  ...
  List<CampusPost> _fallbackPosts() {
    final user = widget.user;
    return [
      _profilePostForUser(_profilePosts[0], user),
      _profilePostForUser(_profilePosts[1], user),
      CampusPost(
        author: user,
        title: '学校食堂新品测评！',
        body: '今天试了二楼窗口的新菜，番茄肥牛饭和芝士焗饭，好吃不贵。',
        topic: '美食探店',
        images: const ['asset:assets/images/profile_food_collage.png'],
        location: '二食堂',
        createdAt: '2天前',
        likes: 87,
        comments: 15,
    ...
    return _ProfileSubPageShell(
      ...
      child: FutureBuilder<List<CampusPost>>(
        ...
        builder: (context, snapshot) {
          ...
          final posts = remotePosts.isEmpty ? _fallbackPosts() : remotePosts;
          return ListView(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text(
                      '共 ${records.isEmpty ? 28 : records.length} 条收藏',
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    if (records.isEmpty) ...[
                      ...
                      const SizedBox(height: 12),
                      const _FavoriteUserCard(
                        kindLabel: '用户',
                        title: '摄影协会',
                        subtitle: '成员 286 · 帖子 342',
                        body: '用镜头记录校园生活，分享摄影技巧，定期组织外拍和作品交流。',
                        action: '已关注',
                        icon: Icons.photo_camera_rounded,
                        iconColor: AppColors.blue,
                        time: '收藏于  5月10日  11:22',
                      ),
                    ],
                  ],
                ),
      ...
      child: FutureBuilder<List<CampusHistoryRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          if (records.isEmpty) {
            return ListView(
              padding: const EdgeInsets.fromLTRB(16, 16, 16, 24),
              children: const [_FallbackHistorySections()],
            );
          }
          return ListView(
            padding: const EdgeInsets.fromLTRB(16, 16, 16, 24),
...
class _FavoritePostsScreen extends StatelessWidget {
...
class _JoinedActivitiesScreen extends StatelessWidget {
  const _JoinedActivitiesScreen();
      ...
      child: ListView(
        ...
        children: const [
          _SegmentedFilterTabs(
            tabs: ['全部', '即将开始', '进行中', '已结束'],
            compact: true,
          ),
          SizedBox(height: 14),
          _JoinedActivityTile(
            title: '校园歌手大赛',
            image: 'asset:assets/images/activity_music_thumb.png',
            time: '2025-05-25（周日）18:30',
            location: '大学生活动中心大礼堂',
            status: '即将开始',
          ...
          _JoinedActivityTile(
            title: '摄影社团采风活动',
            image: 'asset:assets/images/activity_photo_thumb.png',
            time: '2025-05-16（周五）09:00',
            location: '学校东湖公园',
            status: '进行中',
          ...
          _JoinedActivityTile(
            title: 'AI 未来发展趋势讲座',
            image: 'asset:assets/images/activity_ai_head.png',
            time: '2025-05-12（周一）14:00',
            location: '图书馆报告厅',
            status: '已结束',
          ...
          _JoinedActivityTile(
            title: '志愿者在行动',
            image: 'asset:assets/images/activity_volunteer_hands.png',
            time: '2025-05-08（周四）08:30',
            location: '校外社区服务中心',
            status: '已结束',
            statusColor: AppColors.muted,
            checkedLabel: '已参与',
          ...
          _JoinedActivityTile(
            title: '校园篮球友谊赛',
            image: 'asset:assets/images/activity_basketball_court.png',
            time: '2025-05-05（周一）16:00',
            location: '学校篮球场',
            status: '已结束',
            statusColor: AppColors.muted,
            checkedLabel: '已参与',
...
class _MyActivitiesScreen extends StatelessWidget {
      ...
      child: ListView(
        ...
        children: const [
          ...
          _MyActivityModuleCard(
            title: '校园歌手大赛',
            image: 'asset:assets/images/activity_music_thumb.png',
            time: '2024/06/01 18:30',
            location: '大学生活动中心  大礼堂',
            tags: [_TinyTag(label: '可报名', color: AppColors.blue)],
          ),
          SizedBox(height: 14),
          _MyActivityModuleCard(
            title: '摄影社团采风活动',
            ...
            location: '东湖风景区',
            tags: [
              _TinyTag(label: '可报名', color: AppColors.blue),
              _TinyTag(label: '发起人', color: AppColors.green),
            ],
          ),
          SizedBox(height: 14),
          _MyActivityModuleCard(
          ...
          _MyActivityModuleCard(
            ...
            location: '校园及周边社区',
            tags: [_TinyTag(label: '已完成', color: AppColors.muted)],
          ),
        ],
      ),
    );
...
class _SavedPostTile extends StatelessWidget {
  ...
  factory _SavedPostTile.fromPost({
    ...
    return _SavedPostTile(
      title: post.title,
      body: post.body,
      image: post.images.isEmpty
          ? 'asset:assets/images/profile_sunset.png'
          : post.images.first,
      savedAt: savedAt,
      views: post.shares <= 0 ? '0' : '${post.shares * 100}',
      likes: '${post.likes}',
  ...
  Widget build(BuildContext context) {
    return CampusCard(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SmartImage(url: image, width: 132, height: 108, borderRadius: 10),
          const SizedBox(width: 14),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
...
class _JoinedActivityTile extends StatelessWidget {
  const _JoinedActivityTile({
    required this.title,
    required this.image,
    required this.time,
    required this.location,
  ...
  Widget build(BuildContext context) {
    return CampusCard(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SmartImage(url: image, width: 134, height: 108, borderRadius: 10),
          const SizedBox(width: 14),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                _IconTextLine(icon: Icons.calendar_month_outlined, label: time),
                const SizedBox(height: 8),
                _IconTextLine(
                  icon: Icons.location_on_outlined,
                  label: location,
...
class _IconTextLine extends StatelessWidget {
  const _IconTextLine({required this.icon, required this.label});
...
class _StringMetric extends StatelessWidget {
  const _StringMetric({required this.icon, required this.value});
...
class _FavoritePostCard extends StatelessWidget {
  const _FavoritePostCard({required this.user});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: const [
                    Text('2小时前', style: TextStyle(color: AppColors.muted)),
                    SizedBox(width: 8),
                    Text('·', style: TextStyle(color: AppColors.muted)),
                    SizedBox(width: 8),
                    _CompactBadge(label: '# 摄影作品分享', color: AppColors.blue),
                  ],
                ),
                const SizedBox(height: 16),
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 8),
                          Text(
                            '今天的晚霞也太美了！在图书馆顶楼拍到的，分享给大家几个适合拍照的小位置～',
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              color: AppColors.text,
                    ...
                    Column(
                      ...
                      children: const [
                        SmartImage(
                          url: 'asset:assets/images/profile_sunset.png',
                          width: 108,
                          height: 88,
                          borderRadius: 9,
                        ),
...
class _FavoriteActivityCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _FavoriteInfoCard(
      ...
      title: '校园音乐之夜 ♪',
      lines: ['2023年6月10日（周六）  19:00', '大学生活动中心广场', '等 86 人已收藏'],
      image: 'asset:assets/images/favorite_music.png',
      time: '收藏于  5月18日  09:15',
    );
  }
}
...
class _FavoriteTopicCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _FavoriteInfoCard(
      kindLabel: '话题',
      kindColor: AppColors.blue,
      leadingIcon: Icons.tag_rounded,
      leadingColor: AppColors.blue,
      title: '# 期末复习攻略',
      lines: ['3.2万浏览 · 256讨论', '分享你的高效复习方法和学习资料，一起高效备考，期末不挂科！'],
      image: 'asset:assets/images/favorite_topic_book.png',
      time: '收藏于  5月15日  17:48',
    );
  }
}
            ...
            children: [
              SizedBox(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _FavoriteKindChip(label: kindLabel, color: kindColor),
                    const SizedBox(height: 14),
                    IconBubble(
                      icon: leadingIcon,
                      color: leadingColor,
...
class _FavoriteUserCard extends StatelessWidget {
  const _FavoriteUserCard({
    required this.kindLabel,
    required this.title,
    required this.subtitle,
      ...
      child: Stack(
        children: [
          Positioned(
            top: 0,
            left: 0,
            child: _FavoriteKindChip(label: kindLabel, color: AppColors.orange),
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
...
class _FavoriteKindChip extends StatelessWidget {
  const _FavoriteKindChip({required this.label, required this.color});
          ...
          for (var i = 0; i < users.length; i++)
            Positioned(
              ...
              child: Container(
                ...
                child: CampusAvatar(user: users[i], size: 19),
              ),
            ),
        ],
      ),
...
List<Widget> _fallbackSavedPostTiles() {
  return const [
    _SavedPostTile(
      title: '校园日落打卡地推荐',
      body: '分享几个学校里超美的日落打卡点，傍晚去拍照真的很出片。',
      image: 'asset:assets/images/profile_sunset.png',
      savedAt: '收藏于  05-12',
      views: '1.2k',
      likes: '256',
    ...
    _SavedPostTile(
      title: '图书馆自习座位分享',
      body: '整理了几处学习氛围超好的座位，快来看看有没有你喜欢的位置。',
      image: 'asset:assets/images/profile_book.png',
      savedAt: '收藏于  05-11',
      views: '2.3k',
      likes: '312',
    ...
    _SavedPostTile(
      title: '食堂隐藏菜单大公开！',
      body: '这些隐藏菜单好吃又实惠，本校干饭人一定不能错过。',
      image: 'asset:assets/images/profile_food_collage.png',
      savedAt: '收藏于  05-10',
      views: '1.8k',
      likes: '289',
      comments: '55',
...
List<Widget> _fallbackDraftTiles() {
  return const [
    _DraftTile(
      title: '校园春日摄影征集',
      body: '春天的校园总是充满生机，快来分享你镜头下的春日美景吧～',
      image:
          'https://images.unsplash.com/photo-1522383225653-ed111181a951?auto=format&fit=crop&w=700&q=80',
      meta: '上次编辑  05-12 18:30',
      action: '继续编辑',
...
class _FallbackHistorySections extends StatelessWidget {
  const _FallbackHistorySections();
...
class _ProfileTabbedCard extends StatelessWidget {
  const _ProfileTabbedCard({
    required this.tabs,
...
class _ProfilePostList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final sourcePosts = showThirdPost ? _profilePosts : _profilePosts.take(2);
    final posts = sourcePosts
        .map((post) => _profilePostForUser(post, user))
        .toList(growable: false);

    return Column(
      children: [
        for (var i = 0; i < posts.length; i++) ...[
          _ProfilePostTile(post: posts.elementAt(i)),
...
CampusPost _profilePostForUser(CampusPost post, CampusUser user) {
  return CampusPost(
    id: post.id,
    author: user,
    title: post.title,
...
class _ProfileActivityList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        for (var i = 0; i < _profileActivities.length; i++) ...[
          _ProfileActivityTile(entry: _profileActivities[i]),
          if (i != _profileActivities.length - 1)
...
class _ProfileActivityTile extends StatelessWidget {
  const _ProfileActivityTile({required this.entry});

  final _ProfileActivityEntry entry;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _ProfileMetaLine(
                    icon: Icons.groups_2_outlined,
                    label: '${activity.enrolled}/${activity.capacity} 人已报名',
                  ),
                  const SizedBox(height: 8),
                  Align(
                    alignment: Alignment.centerRight,
...
class _ProfileMetaLine extends StatelessWidget {
  const _ProfileMetaLine({required this.icon, required this.label});
...
class _ProfileAlbumList extends StatelessWidget {
  const _ProfileAlbumList();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text(
            '共 36 张  ·  最近更新  今天 18:30',
            style: TextStyle(color: AppColors.muted, fontSize: 14),
          ),
          const SizedBox(height: 16),
          for (var i = 0; i < _albumSections.length; i++) ...[
            _AlbumSectionView(section: _albumSections[i]),
            if (i != _albumSections.length - 1) const SizedBox(height: 18),
          ],
        ],
      ),
    );
...
class _AlbumSectionView extends StatelessWidget {
  const _AlbumSectionView({required this.section});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Row(
          children: [
            Icon(section.icon, color: section.iconColor, size: 23),
            const SizedBox(width: 8),
            Expanded(
              child: Text(
            ...
            const Text('查看全部', style: TextStyle(color: AppColors.muted)),
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            final imageSize = (constraints.maxWidth - 32) / 5;
            return Row(
              children: [
                for (var i = 0; i < section.images.length; i++) ...[
                  ...
                  if (i != section.images.length - 1) const SizedBox(width: 8),
                ],
              ],
            );
          },
...
class _ActivityListCardState extends State<ActivityListCard> {
  ...
  bool get _realRegistered => _isRegistered;

  Future<void> _syncRegistrationState() async {
    final id = _activity.id.trim();
    if (id.isEmpty) {
      if (mounted) {
        setState(() {
          _isRegistered = false;
    ...
    try {
      ...
      final registered = myActivities.any((item) => item.id == id);

      if (!mounted || _activity.id.trim() != id) return;
      setState(() {
        _isRegistered = registered;
        _isCheckingRegistration = false;
      });
    } catch (_) {
      // 未登录、接口失败或后端不可用时，不能误显示“已报名”
      if (!mounted || _activity.id.trim() != id) return;
      setState(() {
        _isRegistered = false;
        _isCheckingRegistration = false;
    ...
    final changed = await Navigator.push<bool>(
      ...
      MaterialPageRoute(
        builder: (_) => ActivityEnrollmentDetailScreen(
          activity: _activity,
          initialRegistered: _realRegistered,
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final isRegistered = _realRegistered;
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  _JoinActivityButton(
                    label: _isCheckingRegistration
                        ? '同步中'
                        : isRegistered
                        ? '已报名'
                        : '报名参加',
                    color: isRegistered ? AppColors.blue : AppColors.green,
                    isLoading: _isCheckingRegistration,
                  ),
                ],
              ),
            ],
